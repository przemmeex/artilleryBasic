...
export async function testDogPage(page: any, step: any) {

    await step('DogPageAllSteps', async () => {
...
export async function testCatPage(page: any, step: any) {
    await step('CatPageAllSteps', async () => {
